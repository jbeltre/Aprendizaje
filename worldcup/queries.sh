...
echo "$($PSQL "SELECT name FROM teams INNER JOIN games ON games.winner_id=teams.team_id OR team_id=games.opponent_id WHERE round='Eighth-Final' AND year=2014 ORDER BY name ASC")"
